...
const PERMISOS_DEFAULT = {
  super_admin: {
    ...
    entradas_inventario:true, ver_historial_entradas:true, reportes:true, gestion_usuarios:true,
  ...
  supervisor: {
    ...
    entradas_inventario:false, ver_historial_entradas:true, reportes:true, gestion_usuarios:false,
  ...
  cajero: {
    ...
    entradas_inventario:false, ver_historial_entradas:false, reportes:false, gestion_usuarios:false,
    config_iva:false, catalogo_bancos:false, sucursales:false, config_fel:false,
